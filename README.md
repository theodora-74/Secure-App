...
Results
MetricValueTotal Tests52Passed52Failed0Pass Rate100.0%STRIDE Categories6Fuzz Payloads15Security Controls10
Architecture
...
Spoofing — credential validation, SQL injection resistance, bcrypt verification, session fixation
Tampering — CSRF enforcement, role injection blocking, HTML sanitisation
Repudiation — login/logout/registration event logging with IP addresses
Information Disclosure — 8 security headers validated, error pages hide stack traces
Denial of Service — rate limiting returns HTTP 429 on threshold breach
Elevation of Privilege — unauthenticated redirect, client-to-admin block, IDOR prevention
...
Setup
bashgit clone https://github.com/theodora-74/Secure-app.git
cd SecurePanel
...
Author
Theodora Filaj — BSc Computing, University of Bolton (2026)
